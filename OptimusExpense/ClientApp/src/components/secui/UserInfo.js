                            ...
                            <div className="box p-shadow-5 pt-2 pb-2">
                                <div className="p-grid p-col-12 pl-4">
                                    <div className="p-col-11">
                                        <p className="pr-1" style={{ 'fontSize': '20px', 'color': '#008CBA', 'font-weight': 'bold' }}>INFORMATII UTILIZATOR</p>
                                    </div>
                                </div>
                                <div className="p-grid p-col-12 pl-4 pt-2 pb-0">
                                    <div className="p-col-11">
                                        ...
                                        <p className="pr-2 pl-1" style={{ 'display': 'inline-block', 'fontSize': '14px', 'font-weight': 'bold', 'color': '#008CBA' }}>Nume angajat:</p>
                                ...
                                <div className="p-grid p-col-12 pl-4 pt-0 pb-0">
                                    <div className="p-col-11">
                                        ...
                                        <p className="pr-2 pl-1" style={{ 'display': 'inline-block', 'fontSize': '14px', 'font-weight': 'bold', 'color': '#008CBA' }}>Sectie:</p>
                                ...
                                <div className="p-grid p-col-12 pl-4 pt-0 pb-0">
                                    <div className="p-col-11">
                                        ...
                                        <p className="pr-2 pl-1" style={{ 'display': 'inline-block', 'fontSize': '14px', 'font-weight': 'bold', 'color': '#008CBA' }}>Manager:</p>
